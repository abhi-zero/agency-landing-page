  ...
  return (
    <div>
      ...
      <div className="group hidden lg:block relative overflow-hidden">
        ...
        <div className="top-[100%] group-hover:top-[0%] absolute flex justify-center items-center-safe bg-neutral-950/40 backdrop-blur-sm w-full h-full transition-all duration-300 ease-in-out">
          <AnchorLinkAsButton
            text={"Learn more"}
            link={link}
