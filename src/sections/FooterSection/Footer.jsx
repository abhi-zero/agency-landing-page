...
import navLinks from "../../utitly/navLinks/index";
...
export default function Footer() {
  return (
    <div>
      <div className="flex flex-col items-center-safe gap-7 bg-cm-green-300 py-[50px] w-full">
        <div className="">
          <svg
            className="text-cm-green-500"
            width="124"
            height="24"
        ...
        <div >
          <div className="flex flex-col items-center-safe gap-10">
